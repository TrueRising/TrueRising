      ...
      <Container>
        <div className="relative overflow-hidden rounded-section border border-white/10 bg-[#0A0A0A]/75 p-6 shadow-premium backdrop-blur-xl md:p-10">
          <video
            ...
            poster="https://images.unsplash.com/photo-1557683316-973673baf926?auto=format&fit=crop&w=1800&q=80"
          >
            <source
              src="https://cdn.coverr.co/videos/coverr-aerial-view-of-city-lights-at-night-1579/1080p.mp4"
              type="video/mp4"
            />
          </video>
